...
class Pokemon(models.Model):
    ...
    picture = models.ImageField(upload_to='pokemon_pic', null=True, blank=True, verbose_name='изображение')

    description = models.CharField(max_length=2000, blank=True, verbose_name='описание')

    title_en = models.CharField(max_length=200, blank=True, verbose_name='английское имя покемона')
    title_jp = models.CharField(max_length=200, blank=True, verbose_name='японское имя покемона')

    previous_evolution = models.ForeignKey('self', on_delete=models.SET_NULL, blank=True, null=True, related_name='next_evolution', verbose_name='из кого эволюционирует')
